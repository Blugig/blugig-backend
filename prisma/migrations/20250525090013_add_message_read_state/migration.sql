...
INSERT INTO "new_Message" ("body", "conversation_id", "id", "media_type", "media_url", "message_type", "offer_id", "sender_admin_id", "sender_user_id", "time") SELECT "body", "conversation_id", "id", "media_type", "media_url", "message_type", "offer_id", "sender_admin_id", "sender_user_id", "time" FROM "Message";
DROP TABLE "Message";
